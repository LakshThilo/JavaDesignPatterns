...
public class Visitor_Pattern {
    ...
    The visitor pattern allows you to do this without making changes to the elements themselves. Instead,
    a separate visitor object is passed to each object to perform the operation.*/
